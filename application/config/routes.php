...
$route['get_airlines'] = 'Administrator/Page/getCategories'; 
$route['airline'] = 'Administrator/Page/add_category'; 
$route['insertAirline'] = 'Administrator/Page/insert_category';
$route['deleteAirline'] = 'Administrator/page/catdelete';
...
// Bill Entry 
$route['get_client_due'] = 'Administrator/Customer/getClientDue';
$route['bill-entry'] = 'Administrator/BillController/billEntry';
$route['bill-edit/(:any)'] = 'Administrator/BillController/billEdit/$1';
$route['save-bill'] = 'Administrator/BillController/saveBill';
$route['bill-invoice-print/(:any)'] = 'Administrator/BillController/billInvoicePrint/$1';
$route['bill-record'] = 'Administrator/BillController/billRecord';
$route['get_bills'] = 'Administrator/BillController/getBills';
$route['get_bills_record'] = 'Administrator/BillController/getBillRecord';
$route['get_billdetails'] = 'Administrator/BillController/getBillDetails';
$route['update-bill'] = 'Administrator/BillController/updateBill';
$route['delete-bill'] = 'Administrator/BillController/deleteBill';
$route['get-profit-loss'] = 'Administrator/BillController/getProfitLoss';
$route['bill-reminder-list'] = 'Administrator/BillController/billReminderList';
$route['get-reminder-list'] = 'Administrator/BillController/getReminderList';
$route['get_pnr'] = 'Administrator/BillController/getPnr';

// send mail
$route['send_mail'] = 'Administrator/BillController/SendMailInvoice';
$route['mail_invoice'] = 'Administrator/BillController/mailInvoice';
