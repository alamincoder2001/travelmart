...
class Products extends CI_Controller {
    ...
    public function addProduct() {
        ...
        try{
            ...
            $res = ['success'=>true, 'message'=>'Route added successfully', 'productId'=>$this->mt->generateProductCode()];
        } catch (Exception $ex){
    ...
    public function updateProduct(){
        ...
        try{
            ...
            $res = ['success'=>true, 'message'=>'Route updated successfully', 'productId'=>$this->mt->generateProductCode()];
        } catch (Exception $ex){
            $res = ['success'=>false, 'message'=>$ex->getMessage()];
        }
    ...
    public function deleteProduct(){
        ...
        try{
            ...
            $res = ['success'=>true, 'message'=>'Route deleted successfully'];
        } catch (Exception $ex){
            $res = ['success'=>false, 'message'=>$ex->getMessage()];
        }
