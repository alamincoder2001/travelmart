...
class Customer extends CI_Controller
{
    ...
    public function getClientDue(){
        ...
        $dueResult = $this->mt->clientDue($clauses);
    ...
    {
        $data['title'] = "Client Payment Reports";
        if ($id != 'pr') {
            $pid["PamentID"] = $id;
            $this->session->set_userdata($pid);
        }
    ...
    function getCustomerLedger(){
        ...
        $payments = $this->db->query("
            select 
                ...
                bm.id,
                bm.date,
                concat('Bill-', bm.invoice) as description,
                bm.total as bill,
                bm.paid,
                bm.due,
                0.00 as returned,
            ...
            where bm.client_id = '$data->customerId'
            and bm.status = 'a'
    ...
    {
        $data['title'] = "Client Advance Payment";
    ...
    {
        $data['title'] = "Client Advance Payment Report";
    ...
    public function customerPaymentHistory(){
        ...
        $data['title'] = "Client Payment History";
