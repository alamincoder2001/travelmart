...
class Reports extends CI_Controller {
    ...
    public function getBalanceSheet()
    {
        ...
        try {
            ...
            //customer dues
            $customer_dues = $this->mt->clientDue(" and c.status = 'a'", $date);
            $bad_debts = $this->mt->clientDue(" and c.status = 'd'", $date);
            ...
            $net_profit = ($profits + $other_income_expense->income + $total_vat) - ($total_discount + $other_income_expense->returned_amount + $other_income_expense->damaged_amount + $other_income_expense->expense + $other_income_expense->employee_payment + $other_income_expense->profit_distribute + $other_income_expense->loan_interest + $other_income_expense->assets_sales_profit_loss );
