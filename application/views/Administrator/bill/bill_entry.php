                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            ...
                            <div class="form-group clearfix" style="display: none;" :style="{display: client.display_name == 'New Client' ? '' : 'none' }">
                                ...
                                <div class="col-md-7">
                                    <input type="text" class="form-control" v-model="client.Customer_Name" required />
                                </div>
                            </div>
                            <div class="form-group clearfix">
                                <label class="control-label col-md-4">Client Phone</label>
                                <div class="col-md-7">
                                    <input type="text" class="form-control" v-model="client.Customer_Mobile" v-bind:disabled="client.display_name == 'New Client' ? false : true" />
                                </div>
                            </div>
                            <div class="form-group clearfix">
                                <label class="control-label col-md-4">Client Email</label>
                                <div class="col-md-7">
                                    <input type="text" class="form-control" v-model="client.Customer_Email" v-bind:disabled="client.display_name == 'New Client' ? false : true" />
                                </div>
                            </div>
                            <div class="form-group clearfix">
                                <label class="control-label col-md-4">Client Address</label>
                                <div class="col-md-7">
                                    <textarea class="form-control" class="form-control" v-model="client.Customer_Address" cols="30" rows="2" v-bind:disabled="client.display_name == 'New Client' ? false : true"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-md-7">
                                    <input type="text" class="form-control" v-model="supplier.Supplier_Mobile" v-bind:disabled="supplier.display_name == 'New Supplier' ? false : true" />
                                </div>
                            </div>
                            <div class="form-group clearfix">
                                <label class="control-label col-md-4">Supplier Email</label>
                                <div class="col-md-7">
                                    <input type="text" class="form-control" v-model="supplier.Supplier_Email" v-bind:disabled="supplier.display_name == 'New Supplier' ? false : true" />
                                </div>
                            </div>
                            <div class="form-group clearfix">
                                <label class="control-label col-md-4">Supplier Address</label>
                                <div class="col-md-7">
                                    <textarea class="form-control" v-model="supplier.Supplier_Address" cols="30" rows="2" v-bind:disabled="supplier.display_name == 'New Supplier' ? false : true"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="widget-main">
                    <form v-on:submit.prevent="addToCart">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="airline" class="col-sm-4 control-label">Select Airline</label>
                                    <div class="col-sm-8 no-padding-right">
                                        <v-select v-bind:options="airlines" v-model="airline" label="ProductCategory_Name"></v-select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Select Route</label>
                                    <div class="col-sm-8 no-padding-right">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8 no-padding-right">
                                        <input type="text" id="name" class="form-control" v-model="route.name" placeholder="Enter name" required />
                                    </div>
                                </div>
                                <!-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8 no-padding-right">
                                        <input type="text" id="phone" class="form-control" v-model="route.phone" placeholder="Enter phone" required />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="flight_date" class="col-sm-4 control-label">Flight Date</label>
                                    <div class="col-sm-8 no-padding-right">
                                ...
                                <div class="form-group">
                                    <label for="return_date" class="col-sm-4 control-label">Return Date</label>
                                    <div class="col-sm-8 no-padding-right">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="pnr" class="col-sm-4 control-label">PNR NO</label>
                                    <div class="col-sm-8 no-padding-right">
                                        <input type="text" id="pnr" class="form-control" v-model="route.pnr_no" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="pnr" class="col-sm-4 control-label">Flight NO</label>
                                    <div class="col-sm-8 no-padding-right">
                                        <input type="text" id="pnr" class="form-control" v-model="route.flight_no" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="pnr" class="col-sm-4 control-label no-padding-right">Fare In BDT</label>
                                    <div class="col-sm-8 no-padding-right">
                                        <input type="text" id="pnr" class="form-control" v-model="route.Product_Purchase_Rate" required />
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="pnr" class="col-sm-4 control-label">Sale Amount</label>
                                    <div class="col-sm-8 no-padding-right">
                                        <input type="text" id="pnr" class="form-control" v-model="route.Product_SellingPrice" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="pnr" class="col-sm-4 control-label">Ticket No</label>
                                    <div class="col-sm-8 no-padding-right">
                                        <input type="text" id="pnr" class="form-control" v-model="route.ticket" required />
                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    <label for="tax" class="col-sm-4 control-label no-padding-right">Tax In BDT</label>
                                    <div class="col-sm-8 no-padding-right">
                                        <input type="text" id="tax" class="form-control" v-model="route.tax_amount" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="pnr" class="col-sm-4 control-label no-padding-right">Discount</label>
                                    <div class="col-sm-8 no-padding-right">
                                        <div class="row">
                                            <div class="col-xs-4">
                                                <input type="number" min="0" id="routeDiscount" class="form-control" v-model="routeDiscount" v-on:input="calculateDiscount"/>
                                            </div>

                                            <label class="col-xs-1 control-label no-padding-right">%</label>

                                            <div class="col-xs-7">
                                                <input type="number" min="0" id="discount" class="form-control" v-model="route.discount" v-on:input="calculateDiscount"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
                                ...
                                <tbody style="display:none;" v-bind:style="{display: cart.length > 0 ? '' : 'none'}">
                                    ...
                                    <tr>
                                        <td colspan="4"><textarea style="width: 100%;font-size:13px;" placeholder="Note" v-model="bill.note"></textarea></td>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="service" class="col-sm-4 control-label">Other Service</label>
                                <div class="col-sm-8 no-padding-right">
                                    <textarea id="service" v-model="bill.other_service" class="form-control" cols="30" rows="2"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="service_amount" class="col-sm-4 control-label">Service Amount</label>
                                <div class="col-sm-8 no-padding-right">
                                    <input type="number" min="0" step="0.01" id="service_amount" class="form-control" v-model="bill.service_amount" v-on:input="calculateTotal" />
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    new Vue({
        ...
        methods: {
            ...
            async getClientDue() {
                await axios.post('/get_client_due', {clientId: this.client.Customer_SlNo})
                .then(res => {
            ...
            calculateTotal() {
                this.bill.purchase_total = this.cart.reduce((prev, curr) => { return prev + parseFloat(curr.purRate)}, 0).toFixed(2);

                let saleTotal =  this.cart.reduce((prev, curr) => { return prev + parseFloat(curr.saleRate)}, 0).toFixed(2);
                let taxTotal =  this.cart.reduce((prev, curr) => { return prev + parseFloat(curr.taxAmount)}, 0).toFixed(2);
                let discountTotal =  this.cart.reduce((prev, curr) => { return prev + parseFloat(curr.discount)}, 0).toFixed(2);
                ...
                if(event.target.id == 'discountPercent'){
					this.bill.discount = ((parseFloat(this.bill.subTotal) * parseFloat(this.discountPercent)) / 100).toFixed(2);
				} else {
					this.discountPercent = (parseFloat(this.bill.discount) / parseFloat(this.bill.subTotal) * 100).toFixed(2);
				}
            ...
            async getBills() {
                await axios.post('/get_bills', {billId: this.bill.id})
                .then(res => {
                    let r = res.data;
					let bills = r.bills[0];
