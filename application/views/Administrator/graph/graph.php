...
<div id="graph">
    ...
    <div class="row" v-if="showData" style="display:none;" v-bind:style="{ display: showData ? '' : 'none' }">
        ...
        <div class="col-md-2  col-xs-6">
            <div class="widgets" style="border-top: 5px solid #ff8000;">
                ...
                <div class="widget-content">
                    <div class="widget-text">Client Due</div>
                    <div class="widget-value"><?php echo $this->session->userdata('Currency_Name');?> {{ clientDue | decimal }}</div>
                </div>
            </div>
        </div>
        <div class="col-md-2  col-xs-6">
    ...
    <div class="row">
        <div class="col-md-6">
            <h3 class="text-center">Top Sold Route</h3>
            <top-product-chart
            type="PieChart"
            :data="topRoutes"
            :options="topRoutesOptions"
            />
        </div>
        <div class="col-md-4 col-md-offset-2">
            <table class="table custom-table-bordered">
                <thead>
                    <tr>
                        <td class="text-center" colspan="2" style="background-color: #224079;color: white;font-weight: 900;">Top Clients</td>
                    </tr>
                </thead>
                <tbody>
    ...
    new Vue({
        ...
        data () {
            return {
                ...
                topRoutesOptions: {
                    chart: {
                        title: 'Top Sold Route',
                        subtitle: "Top sold Route"
                    }
                },
                // topCustomers: [
                //     ['Customer', 'Amount']
        ...
        methods: {
            getGraphData(){
                axios.get('/get_graph_data').then(res => {
                    ...
                    this.salesText = res.data.bills_text.map(sale => {
                        return sale.bill_text;
                    }).join(' | ');
                    ...
                    this.clientDue        = res.data.client_due;
                    ...
                    res.data.top_routes.forEach(p => {
                        this.topRoutes.push([p.product_name, parseFloat(p.sold_quantity)]);
                    })
