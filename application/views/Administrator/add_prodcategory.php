	...
	<div class="col-xs-12">
		...
		<div class="form-horizontal">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Airline Name  </label>
				<label class="col-sm-1 control-label no-padding-right">:</label>
				<div class="col-sm-3">
					<input type="text" id="catname" name="catname" placeholder="Airline Name" value="<?php echo set_value('catname'); ?>" class="form-control" />
					<span id="msg"></span>
			...
			<div class="form-group">
				...
				<label class="col-sm-1 control-label no-padding-right">:</label>
				<div class="col-sm-3">
					<textarea name="catdescrip" id="catdescrip" class="form-control" placeholder="Airline Description" ></textarea>
				</div>
			</div>
...
<script type="text/javascript">
    function submit(){
        ...
        var urldata = "<?php echo base_url();?>insertAirline";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
...
<script type="text/javascript">
    function deleted(id){
        ...
        var urldata = "<?php echo base_url();?>deleteAirline";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
            success:function(data){
                alert(data);
				window.location.href='<?php echo base_url(); ?>airline';
            }
        });
		};
    }
