						...
						<li class="light-blue dropdown-modal">
							<?php
								...
								$reminders = $this->db->query("
									...
									where bd.status = 'a'
									and bd.reminder_date = ? 
									and bd.branch_id = ?
								", [$date, $this->session->userdata('BRANCHid')])->result();
								
								$totalReminder = count($reminders);
							?>
							<?php if (array_search("bill-reminder-list", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
							<a href="<?php echo base_url(); ?>bill-reminder-list">
								<i class="ace-icon fa fa-bell icon-animated-bell"></i>
								<span class="badge badge-important"><?php echo $totalReminder; ?></span>
							</a>
							<?php endif; ?>
