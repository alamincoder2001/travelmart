		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			<div class="col-md-5">
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Client Id <span style="color:red;">*</span></label>
					<div class="col-md-7">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Client Name <span style="color:red;">*</span></label>
					<div class="col-md-7">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Client Address <span style="color:red;">*</span></label>
					<div class="col-md-7">
				...
				<!-- <div class="form-group clearfix">
					<label class="control-label col-md-4">Select Area <span style="color:red;">*</span></label>
					<div class="col-md-7">
			...
			<div class="col-md-5">
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Mobile Number <span style="color:red;">*</span></label>
					<div class="col-md-7">
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="number" step="0.01" class="form-control" v-model="customer.previous_due">
					</div>
				</div>
		...
		data(){
			return {
				...
				columns: [
                    ...
                    { label: 'Client Id', field: 'Customer_Code', align: 'center', filterable: false },
                    { label: 'Client Name', field: 'Customer_Name', align: 'center' },
                    // { label: 'Area', field: 'District_Name', align: 'center' },
                    { label: 'Contact Number', field: 'Customer_Mobile', align: 'center' },
                    { label: 'Previous Due', field: 'previous_due', align: 'center' },
