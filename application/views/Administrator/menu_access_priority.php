...
<div id="userAccess">
    ...
    <div class="row" id="accessRow">
        <div class="col-md-3">
            ...
            <div class="group">
                <input type="checkbox" id="bills" class="group-head" @click="onClickGroupHeads"> <strong>Bills</strong>
                <ul ref="bills">
                    <li><input type="checkbox" class="access" value="bill-entry" v-model="access"> Bill Entry</li>
                    <li><input type="checkbox" class="access" value="bill-record" v-model="access"> Bill Record</li>
                    <li><input type="checkbox" class="access" value="bill-reminder-list" v-model="access"> Bill Reminder List</li>
                </ul>
            </div>
            ...
            <div class="group">
                ...
                <ul ref="accounts">
                    ...
                    <li><input type="checkbox" class="access" value="customerPaymentPage" v-model="access"> Client Payment</li>
        ...
        <div class="col-md-3">
            ...
            <div class="group">
                <input type="checkbox" id="Reports" class="group-head" @click="onClickGroupHeads"> <strong>Reports</strong>
                <ul ref="Reports">
                    <li><input type="checkbox" class="access" value="customerDue" v-model="access"> Client Due List</li>
                    <li><input type="checkbox" class="access" value="supplierDue" v-model="access"> Supplier Due List</li>
                    <li><input type="checkbox" class="access" value="supplierPaymentReport" v-model="access"> Supplier Payment Report</li>
                    <li><input type="checkbox" class="access" value="customerPaymentReport" v-model="access"> Client Payment Report</li>
                    <li><input type="checkbox" class="access" value="customer_payment_history" v-model="access">Client Payment History</li>
                </ul>
            </div>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="admin">
                    ...
                    <li><input type="checkbox" class="access" value="product" v-model="access"> Route Entry</li>
                    <li><input type="checkbox" class="access" value="productlist" v-model="access"> Route List</li>
                    <li><input type="checkbox" class="access" value="product_ledger" v-model="access"> Route Ledger</li>
                    ...
                    <li><input type="checkbox" class="access" value="airline" v-model="access"> Airline Entry</li>
