	...
	<ul class="nav nav-list">
		...
		<li class="">
			<a href="<?php echo base_url(); ?>module/BillModule">
				...
				<span class="menu-text"> Bill Module </span>
			</a>
			<b class="arrow"></b>
		</li>
	...
	<ul class="nav nav-list">
		...
		<?php if (
			...
			<li class="">
				<a href="<?php echo base_url(); ?>" class="dropdown-toggle">
					...
					<span class="menu-text"> Route Info </span>
		...
		<li class="">
			...
			<ul class="submenu">
				...
				<?php if (array_search("airline", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
					<li class="">
						<a href="<?php echo base_url(); ?>airline">
							<i class="menu-icon fa fa-caret-right"></i>
							Airline entry
						</a>
						<b class="arrow"></b>
...
<?php } elseif($module == 'BillModule') {?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("bill-entry", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>bill-entry">
					<i class="menu-icon fa fa-money"></i>
		...
		<?php if (array_search("bill-record", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>bill-record">
					<i class="menu-icon fa fa-list"></i>
		...
		<?php if (array_search("airline", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>airline">
					...
					<span class="menu-text"> Airline Entry </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (array_search("product", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>product">
					<i class="menu-icon fa fa-map-marker"></i>
					<span class="menu-text"> Route Entry </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		<?php if (array_search("productlist", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>productlist">
					<i class="menu-icon fa fa-list"></i>
					<span class="menu-text"> Route List </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (array_search("customerPaymentPage", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>customerPaymentPage">
					<i class="menu-icon fa fa-money"></i>
					<span class="menu-text"> Client Payment </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
