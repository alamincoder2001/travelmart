...
<div class="content_scroll" style="width: 850px; ">
    ...
    <div id="reportContent">
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-12">
                <h6 style="background:#ddd; text-align: center; font-size: 18px; font-weight: 900; padding: 5px; color: #bd4700;">Client Payment Invoice</h6>
            </div>
        </div>
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-12">
        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-12 text-left;">
                ...
                <div style="float:right;">
                    <img src="/uploads/sill.jpeg" style="width: 130px;" />
                    <br><br>
                    <strong style="text-decoration: overline;">Autorizied signature</strong>
                </div>
            </div>
        </div>
    </div>
