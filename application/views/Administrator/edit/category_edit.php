	...
	<div class="col-xs-12">
		...
		<div class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" id="catname" name="catname" placeholder="Airline Name"  value="<?php echo $selected->ProductCategory_Name; ?>" class="col-xs-10 col-sm-4" />
