		...
		<div class="row" style="padding-top:10px;">
			<div class="col-md-6">
				...
				<table class="table table-bordered table-condensed">
					...
					<tbody style="display:none;" v-bind:style="{display: bills.length > 0 ? '' : 'none'}">
						<tr v-for="bill in bills">
							<td>{{ bill.invoice }}</td>
							<td>{{ bill.date }}</td>
							<td>{{ bill.Customer_Name }}</td>
							<td style="text-align:right;">{{ bill.paid | decimal }}</td>
						</tr>
					</tbody>
					<tfoot>
						<tr style="font-weight:bold;">
							...
							<td style="text-align:right;">
								<span v-if="sales.length == 0">0.00</span>
								<span style="display:none;" v-bind:style="{display: sales.length > 0 ? '' : 'none'}">{{ totalBills | decimal }}</span>
							</td>
						</tr>
					</tfoot>
				</table>
				...
				<table class="table table-bordered table-condensed">
					<thead>
						<tr style="background: #dee4dc;">
							<th colspan="4">Received from Clients</th>
						</tr>
						<tr>
							<th>Invoice</th>
							<th>Date</th>
			...
			<div class="col-md-6">
				...
				<table class="table table-bordered table-condensed">
					<thead>
						<tr style="background: #dee4dc;">
							<th colspan="4">Paid to Clients</th>
						</tr>
						<tr>
							<th>Invoice</th>
							<th>Date</th>
