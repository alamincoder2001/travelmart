const billInvoice = Vue.component('bill-invoice', {
                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                ...
                                <tr v-if="bills.service_amount > 0">
                                    ...
                                    <td colspan="4" style="text-align:left">{{ bills.other_service }}</td>
    ...
    methods: {
        ...
        sendMail() {
            let data = {
                email: this.bills.Customer_Email, invoice: this.bills.id, invoic_no: this.bills.invoice, InWord:this.convertNumberToWords(this.bills.total)
            }
